...
RGB = load('RGB_color_space_MPs.mat');
HSV = load('HSV_color_space_MPs.mat');
...
HSV_mean = squeeze(mean(HSV_cart));
HSV_std  = squeeze(std(HSV_cart));

%% Save the Mean and Std
save('HSV_mean_MPs.mat', "HSV_mean");
save('HSV_std_MPs.mat',  "HSV_std");